...
\newthought{Legitimacy} is a topic in political science and organisational institutionalism, but it underlies engineering and planning too.  It comes in many forms\footnote{Including normative or sociological legitimacy; through consent, trust or reasonableness; as an unconditional duty or as part conditional normative support}: standards and laws state what 'should' be done and who 'shall' give way;  outputs of capacity analysis software are trusted; and many impact assessment reports conclude that 'the proposal can be \smallcaps{reasonably} accommodated on the existing road network.'  But sometimes technically appropriate transport improvement proposals are delegitimised, or projects are built but later removed for non-engineering or planning-related reasons: Mayor Rob Ford of the Toronto declared that the "war on the car is over"; Melbourne's East-West link was cancelled and bus lanes in Stud Road were removed after elections in accordance with political promises.  

The findings described here emerged from case study research, which generated a simple, two-axis framework for exploring and understanding legitimisation and delegitimisation in transport policy and implementation. The x-axis shows the level\footnote{Of transit priority, bicycle facility or some other measure} that is legitimate 
...
\section{Legitimacy before implementation}

\subsection{A1. Dashboards in Toronto}

\subsection{A2. Visionary plans in Curitiba and Zurich}

\subsection{A3. The Swiss vote; Canadians use process}

\section{Avoiding impacts}
\subsection{B1. Under Eglinton}

\subsection{B2. Widening Stud Road}

\subsection{B3. Hook turns in Clarendon Street}

\section{Legitimacy through implementation}

\subsection{C1. Incremental BRT and LRT}

\subsection{C2. Pop-ups (dictatorships sold seperately)}

\subsection{C3. Clarendon and King on trial}
